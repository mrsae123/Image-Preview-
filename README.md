...
Highlights since v2.13.6:

- Quick Lookup is now a rope-and-anchor: it sways by itself, pull it down to open, tap or pull again to close.
- Rename for saved images and GIFs. It only changes the label, so images can no longer be lost.
- Fixed the 🎮 Game Corner button and Save preview.
- Closing pop-ups, the panel and the game now animates like opening does.
- Rewritten ❔ guide.
